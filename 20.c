...
int main()
{
  ...
  printf("The new priority of the running process with PID: %d is %d\n",procid,pr);
  return 0;
}

/****************************************OUTPUT************************************************/  
/*
  aishjp@Aish-Linux:~/my-repo$ gcc 20.c
  aishjp@Aish-Linux:~/my-repo$ ./a.out
  The priority of the running process with PID: 33895 is 0
  The new priority of the running process with PID: 33895 is 5
*/
