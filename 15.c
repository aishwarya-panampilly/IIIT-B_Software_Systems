...
/******************************************OUTPUT************************************************/
/*
  Environmental Variables of User
SHELL=/bin/bash
SESSION_MANAGER=local/Aish-Linux:@/tmp/.ICE-unix/2682,unix/Aish-Linux:/tmp/.ICE-unix/2682
QT_ACCESSIBILITY=1
COLORTERM=truecolor
...
PWD=/home/aishjp/my-repo
LOGNAME=aishjp
XDG_SESSION_DESKTOP=ubuntu
XDG_SESSION_TYPE=wayland
SYSTEMD_EXEC_PID=2725
XAUTHORITY=/run/user/1000/.mutter-Xwaylandauth.1GN8S2
HOME=/home/aishjp
USERNAME=aishjp
IM_CONFIG_PHASE=1
LANG=en_IN
...
GNOME_TERMINAL_SCREEN=/org/gnome/Terminal/screen/b90bfb9d_cfcb_4fee_818c_e558145ea565
